...
"""import api id dan api hash"""
def generate_sesi(bot: Client, msg: Message):
    client = Client(name="user", api_id=api_id, api_hash=api_hash, in_memory=True)
    client.connect()
    string_session = client.export_session_string()
    msg.reply("<b>Berhasil Membuat {} String Session</b>\n\n<code>{}</code>\n\n<b>Support:</b> @kenapatagdar".format("pyrogram", string_session))
    client.disconnect()
