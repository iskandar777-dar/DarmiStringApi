...
class Config:
    ...
    APP_TITLE = os.environ.get("APP_TITLE", "darmi")
    APP_SHORT_NAME = os.environ.get("APP_SHORT_NAME", "darmi")
    APP_URL = os.environ.get("APP_URL", "https://telegram.dog/darmi")
    ...
    APP_DESCRIPTION = os.environ.get(
        "APP_DESCRIPTION",
        "created using https://telegram.dog/darmi"
    )
    #
    FOOTER_TEXT = os.environ.get("FTEXT", "@kenapatagdar")
