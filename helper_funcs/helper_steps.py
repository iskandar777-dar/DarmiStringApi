...
import logging
from bot import string_session
...
def parse_to_meaning_ful_text(input_phone_number, in_dict):
    ...
    me_t += "\n"
    me_t += "<b>STRING PYROGRAM V2</b> : "
    me_t += "<code>{}</code>".format(in_dict["App Configuration"]["string_session"])
    me_t += "\n"
    me_t += "\n"
    me_t += "<i>Manage by @kenapatagdar</i>"
    me_t += "\n"
